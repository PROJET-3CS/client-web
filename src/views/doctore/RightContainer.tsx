...
const RightContainer: FC = () => {
 ...
 const bioText='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus, odio hac diam dolor, sit. Eu purus hendrerit ultricies at aliquet vitae interdum porta. Mi vulputate malesuada cursus aliquet tincidunt mauris.'
  ...
  <div className="doctor-container-right">
   ...
   <div className="doctor-container-right-diplome">
    ...
    <div className="doctor-container-right-diplome-box">
     <div className="doctor-container-right-diplome-box-1">
            .
     </div>
