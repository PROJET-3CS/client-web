...
const EditCancelIndAppointment: FC<Props> = ({ modal, toggle, medecins, appointment, patients }) => {
 // ===========================================================================
 // Dispatch
 // ==========================================================================
   ...
   >
    <ModalBody className="newappointment__resultmodal-body">
     ...
     <div>
      ...
      <div className="newappointment__resultmodal-buttonscontainer">
       <div className="newappointment__resultmodal-buttons">
        <AwesomeButton>Save changes</AwesomeButton>
       </div>
       <div className="newappointment__resultmodal-buttons">
        <AwesomeButton>Cancel appointment</AwesomeButton>
       </div>
      </div>
     </div>
    </ModalBody>
...
export default EditCancelIndAppointment
