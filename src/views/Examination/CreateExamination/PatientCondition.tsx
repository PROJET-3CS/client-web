  ...
  <Layout>
   ...
   <FormGroup className="createExamination">
    ...
    <Card className="createExamination__PatInterro-card">
     ...
     <Col className="createExamination__PatInterro-card--col">
      <Row md="2" className="createExamination__PatInterro-card--row">
       <PatientStateBox title="Patient en etat de choque" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam cursus ornare posuere. Mauris fermentum non lig."/>
       <PatientStateBox title="Patient en etat de comma" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam cursus ornare posuere. Mauris fermentum non lig."/>
      </Row>
      <Row md="2" className="createExamination__PatInterro-card--row">
       <PatientStateBox title="Patient en etat de fatigue" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam cursus ornare posuere. Mauris fermentum non lig."/>
       <PatientStateBox title="Patient en etat normal" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam cursus ornare posuere. Mauris fermentum non lig."/>
      </Row>
     </Col>
    </Card>
