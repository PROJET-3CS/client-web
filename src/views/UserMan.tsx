    ...
    <Row>
     ...
     <Col md='6' sm='6' xs='6' className='navbar1'>
      <ul className='navIcons'>
       ...
       <li className='navIcon'><FontAwesomeIcon icon="bell" /></li>
       <li className='navIcon'><FontAwesomeIcon icon="cog" /></li>
      </ul>
     </Col>
    </Row>
